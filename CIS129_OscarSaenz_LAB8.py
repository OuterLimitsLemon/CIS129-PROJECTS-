...
print()
print("-------------------------------------------------------\n")
print("We invite you to support our team.")
print("Please consider making a $500,000 donation to our Patreon today!")
print()
print()
...
print("Goodbye! That $500,000 Patreon offer is still on the table btw!")
print()
